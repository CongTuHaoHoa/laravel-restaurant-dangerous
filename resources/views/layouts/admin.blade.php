...
<body class="m-0 font-sans text-base antialiased font-normal dark:bg-slate-900 leading-default bg-gray-50 text-slate-500">
    ...
    <aside class="fixed inset-y-0 flex-wrap items-center justify-between block w-full p-0 my-4 overflow-y-auto antialiased transition-transform duration-200 -translate-x-full bg-white border-0 shadow-xl dark:shadow-none dark:bg-slate-850 max-w-64 ease-nav-brand z-990 xl:ml-6 rounded-2xl xl:left-0 xl:translate-x-0" aria-expanded="false">
            ...
            <ul class="flex flex-col pl-0 mb-0">
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 {{ $viewData['activate'] == 'employee' ? 'bg-blue-500/13 font-semibold text-slate-700' : '' }} dark:text-white dark:opacity-80 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors" href="{{ route('admin.employee') }}">
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Nhân viên</span>
                    </a>
                </li>
            </ul>
        </div>
        <div class="mx-4">
            ...
            <a href="{{ route('admin.profile') }}" class="inline-block w-full px-8 py-2 mb-2 text-xs font-bold leading-normal text-center text-white capitalize transition-all ease-in rounded-lg shadow-md bg-blue-500 bg-150 hover:shadow-xs hover:-translate-y-px">Thông tin cá nhân</a>
            <a class="inline-block w-full px-8 py-2 text-xs font-bold leading-normal text-center  text-danger border-danger border-2 align-middle transition-all ease-in rounded-lg shadow-md select-none bg-150 bg-x-25 hover:shadow-xs hover:-translate-y-px" href="https://www.creative-tim.com/product/argon-dashboard-pro-tailwind?ref=sidebarfree" target="_blank">Đăng xuất</a>
        </div>
    </aside>
