                            ...
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    ...
                                    <div id="drop-zone" class="relative group">
                                        <div class="relative overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-850 border-2 border-dashed border-slate-300 dark:border-slate-600 rounded-2xl transition-all duration-300 hover:border-cyan-400 dark:hover:border-cyan-500 hover:shadow-lg" style="min-height: 320px;">
                                            <!-- Preview Image -->
                                            <img id="category-image-previewer" class="absolute inset-0 w-full h-full object-cover rounded-2xl z-10" src="{{ asset('/storage/category/'.$viewData['category']->CTG_IMAGE) }}" alt="{{ $viewData['category']->CTG_NAME }}"/>
                                            
                                            <!-- Upload Placeholder (Hidden initially) -->
